    ...
    <a-layout-header>
      ...
      >
        ...
        <a-menu-item key="board">
          <router-link to="/board"><a-icon type="notification" /> 公告 </router-link>
        </a-menu-item>
        ...
        <a-menu-item key="test">
          <router-link to="/test/intro"> <a-icon type="project" /> 在线测评</router-link>
        </a-menu-item>

        <a-menu-item key="talk">
          <router-link to="/talk"><a-icon type="file-text" /> 留言板</router-link>
        </a-menu-item>
